...
--
-- Host: localhost    Database: entrepreneurship_system
-- ------------------------------------------------------
...
CREATE TABLE `carousel` (
  ...
  `project_id` int DEFAULT NULL COMMENT '项目ID%title%title|项目标题',
  `img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='轮播图信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `carousel` VALUES (4,1,'http://localhost:9090/files/download/1748326309322-轮播图1.jpg'),(5,4,'http://localhost:9090/files/download/1748326320214-轮播图2.jpg'),(6,2,'http://localhost:9090/files/download/1748326329652-轮播图3.jpg');
...
CREATE TABLE `certify` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `teacher_id` int DEFAULT NULL COMMENT '教师ID%name%name|教师名称',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='认证信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `certify` VALUES (27,10,'张三','男','340201200301012222','http://localhost:9090/files/download/1748310997910-idcard.png','http://localhost:9090/files/download/1748311001892-card.jpg','2025-05-27 09:56:42','审核通过',''),(28,12,'郭江','男','340201198001018888','http://localhost:9090/files/download/1748421558135-idcard.png','http://localhost:9090/files/download/1748421560691-card.jpg','2025-05-28 16:39:21','审核通过',NULL),(30,14,'111','男','111','http://localhost:9090/files/download/1748841534675-idcard.png','http://localhost:9090/files/download/1748841544929-card.jpg','2025-06-02 13:19:05','审核通过',NULL);
...
CREATE TABLE `classify` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='分类信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `classify` VALUES (8,'模式创新型'),(9,'技术创新型'),(10,'内容创新型');
...
CREATE TABLE `collect` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `project_id` int DEFAULT NULL COMMENT '项目ID%name%name|项目名称',
  `user_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户ID%name%name|用户名称',
  `time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='收藏信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `competition` (
  ...
  `img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='大赛动态';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `enroll` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='报名信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `enroll` VALUES (20,5,12,'2025-05-28 17:44:36','审核通过',NULL,'王甜甜','17725803127','生物医学工程研二，逻辑思维清晰，善于分析和解决技术问题；具备较强的创新思维，能提出传感器优化方案；团队协作能力良好，与其他成员高效配合。','张三',10),(21,3,12,'2025-05-29 19:51:38','审核通过',NULL,'王甜甜','18725803157','计算机科学与技术大三本科生，逻辑思维严谨，善于解决代码问题；具备良好的团队协作意识，能与后端、设计人员高效配合；注重代码质量与性能优化，工作责任心强。','张三',10),(22,5,10,'2025-05-30 15:41:11','审核通过',NULL,'明守望','18877776666','36666','张三',10);
/*!40000 ALTER TABLE `enroll` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `excellent_topic`
--
...
CREATE TABLE `excellent_topic` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='优秀选题库表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `excellent_topic`
--

LOCK TABLES `excellent_topic` WRITE;
/*!40000 ALTER TABLE `excellent_topic` DISABLE KEYS */;
INSERT INTO `excellent_topic` VALUES (1,'基于AI的智能垃圾分类系统','利用深度学习技术，开发能够自动识别和分类垃圾的智能系统，提高垃圾分类效率','技术创新','2023年全国大学生创新创业大赛金奖',2023,'AI,垃圾分类,深度学习','http://localhost:9090/files/download/1748334301734-万物有灵 创业项目.png'),(2,'乡村电商助农平台','搭建连接农户和消费者的电商平台，帮助农产品销售，促进乡村振兴','商业模式','2022年创青春大学生创业大赛银奖',2022,'电商,助农,乡村振兴','http://localhost:9090/files/download/1748334312004-建筑涂层 创业项目.png'),(3,'大学生心理健康监测APP','基于大数据分析的心理健康监测应用，为大学生提供心理健康评估和建议','社会创新','2023年互联网+大学生创新创业大赛铜奖',2023,'心理健康,大数据,APP','http://localhost:9090/files/download/1748334320764-时空记忆匣 创业项目.png'),(4,'智能家居物联网系统','基于物联网技术的智能家居控制系统，实现家庭设备的智能化管理','技术创新','2024年大学生创新创业大赛优秀奖',2024,'物联网,智能家居,云计算','http://localhost:9090/files/download/1748334329398-非遗焕新 创业项目.png'),(5,'绿色能源监测平台','新能源发电效率监测与优化平台，助力绿色能源发展','环境保护','2024年环保创新大赛金奖',2024,'新能源,监测,绿色发展3','http://localhost:9090/files/download/1750323639353-1748334347115-水质检测 创新项目.png'),(6,'校园智慧后勤系统','基于大数据的校园后勤服务智能化改造项目','社会创新','2023年智慧校园创新大赛银奖',2023,'智慧校园,后勤,大数据','http://localhost:9090/files/download/1748334347115-水质检测 创新项目.png');
/*!40000 ALTER TABLE `excellent_topic` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `innovation_evaluation`
--
...
CREATE TABLE `innovation_evaluation` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='创新能力评价表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `innovation_evaluation`
--

LOCK TABLES `innovation_evaluation` WRITE;
/*!40000 ALTER TABLE `innovation_evaluation` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `innovation_evaluation` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `notice` VALUES (1,'大学生创业平台导师招募公告','各位业界精英：\n为强化创业服务生态，平台现面向社会公开招募创业导师。招募对象包括企业家、投资人、行业专家等，需具备 5 年以上相关领域经验，能提供项目诊断、资源对接等指导。导师可优先参与平台高端峰会，获得品牌曝光机会。携手培育青年创客，共筑创业梦想！','2025-06-01 10:00:00'),(2,'大学生创业平台入驻福利公告','各位创业者：为助力项目孵化，平台即日起推出入驻福利活动：前 50 名入驻企业可享免费办公空间试用 1 个月、创业导师 1 对 1 指导机会及政策申报全程协助。活动截止至 2025 年 6 月 15 日，详情可登录平台 \"活动中心\" 查看。把握机遇，开启创业新征程！','2025-06-01 10:00:00'),(3,'大学生创业平台系统升级公告','亲爱的用户，为优化服务体验，平台将于 2025 年 5 月 31 日 8:00-12:00 进行系统升级，主要优化项目申报流程、新增导师在线答疑模块并修复部分页面显示问题，期间平台暂停访问，已提交项目不受影响，升级后请重新登录，感谢您的理解与支持！','2025-06-01 10:00:00');
...
CREATE TABLE `project` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `teacher_id` int DEFAULT NULL COMMENT '教师%name%name|教师名称',
  `classify_id` int DEFAULT NULL COMMENT '分类%name%name|分类名称',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '标题',
  `introduce` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '简介',
  ...
  `time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='创业项目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `promote` (
  ...
  `views` int DEFAULT '0' COMMENT '浏览量',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='宣传视频信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `promote` VALUES (7,'http://localhost:9090/files/download/1748480649712-中国国际大学生创新大赛（2024）宣传片.jpg','http://localhost:9090/files/download/1748480653987-1.中国国际大学生创新大赛（2024）宣传片(Av113627050805970,P1).mp4','中国国际大学生创新大赛宣传片','2025-05-29 09:04:52',1),(8,'http://localhost:9090/files/download/1748480951415-中国创新创业大赛宣传片.jpg','http://localhost:9090/files/download/1748862424396-1.中国创新创业大赛宣传片(Av216594448,P1).mp4','中国创新创业大赛宣传片','2025-05-29 09:04:52',1),(9,'http://localhost:9090/files/download/1748480982698-\"大片来袭\"！2022中国创新创业成果交易会宣传片上线！！.jpg','http://localhost:9090/files/download/1748862415113-1.\"大片来袭\"！2022中国创新创业成果交易会宣传片上线！！(Av430070646,P1).mp4','中国创新创业成果交易会宣传片','2025-05-29 09:04:52',0),(10,'http://localhost:9090/files/download/1748481003549-《骄傲的少年》.jpg','http://localhost:9090/files/download/1748862261947-《骄傲的少年》MV_ 广东工业大学第七届_互联网_大学生创新创业大赛主题宣传片 - 1.6.23骄傲的少年(Av673945053,P1) (1).mp4','《骄傲的少年》互联网+ 大学生创新创业大赛主题宣传片','2025-05-29 09:04:52',3),(11,'http://localhost:9090/files/download/1748481045532-《韶华》- 山东理工大学大学生科技创新与创业中心15周年宣传片 「一镜到底」「无缝转场」创意影片.jpg','http://localhost:9090/files/download/1748862401337-1.《韶华》- 山东理工大学大学生科技创新与创业中心15周年宣传片 「一镜到底」(Av77215322,P1) .mp4','大学生科技创新与创业中心宣传片','2025-05-29 09:04:52',2),(12,'http://localhost:9090/files/download/1748481076845-【宣传短片】互联网+大学生创新创业大赛宣传短片.jpg','http://localhost:9090/files/download/1748862451136-1.鱼菜共生国赛高清版.mp4','互联网+大学生创新创业大赛宣传短片','2025-05-29 09:04:52',4);
...
CREATE TABLE `qa` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `teacher_id` int DEFAULT NULL COMMENT '教师%name%name|教师名称',
  `user_id` int DEFAULT NULL COMMENT '用户%name%name|用户名称',
  ...
  `img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='创业问答';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `submit` (
  ...
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '原因',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='任务成果';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `submit` VALUES (3,10,1,10,'6666666','http://localhost:9090/files/download/1748519185531-小明.docx','2025-05-29 19:46:26','审核通过',NULL),(4,10,1,10,'5656565','http://localhost:9090/files/download/1748591218445-《骄傲的少年》.jpg','2025-05-30 15:47:21','审核通过',NULL);
...
CREATE TABLE `task` (
  ...
  `time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='任务信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `task` VALUES (1,10,5,'基于纳米光子晶体的智能自修复建筑涂层系统创业项目任务','王甜甜同学：负责技术研发，调研前沿技术设计 3 种复合配方，完成小样制备与核心指标测试，每周输出技术迭代报告；王大壮同学：聚焦产品落地，协调中试设备、调研原材料供应商，制定产品标准并完成合规检测；张小明同学： 主攻市场与运营，调研 50 家建筑企业锁定目标场景，制作 Demo 收集反馈，设计商业模式并搭建新媒体矩阵推广。','2025-05-28 17:56:01'),(3,10,3,'\"非遗焕新・数字共生\" 文化传承项目任务','技术开发：负责搭建非遗数字化平台，运用 3D 扫描、VR 全景技术对非遗技艺、文物进行沉浸式数字建模，开发适配移动端的 AR 互动程序（如用户扫描非遗纹样可触发动态文化故事），同步实现多端数据互通与内容管理系统开发，确保平台技术稳定性与用户体验流畅性。 资源整合：对接地方文旅局、非遗传承人，签订数字化合作协议，建立非遗资源数据库（涵盖传统工艺、民俗文化、传承人影像等）；引入高校科研团队作为技术顾问，联合申请非遗数字化保护课题，提升项目专业性与政策匹配度；与文创企业合作开发数字藏品、衍生 IP，探索 \"非遗 + 电商\" 变现路径。 运营推广：通过短视频平台（抖音、快手）发布非遗数字内容制作过程，打造 \"数字传承人\" IP；策划 \"非遗数字焕新大赛\"，吸引设计师、开发者参与非遗元素再创作，形成 UGC 内容生态；对接教育机构推出 \"非遗数字课堂\"，向中小学、高校提供定制化教学资源，扩大 B 端用户群体；定期举办线下体验活动（如 VR 非遗展），结合线上直播引流，提升平台知名度与用户粘性。同时，持续关注政策动态，申报文化和科技融合示范项目，争取资金与资源支持，确保项目可持续发展。','2025-05-29 20:00:26');
...
CREATE TABLE `teacher` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teacher` VALUES (10,'zzz','123','TEACHER','张三','15525976327','666@qq.com','http://localhost:9090/files/download/1748253073857-10.jpg','认证通过'),(12,'yyy','123','TEACHER','小郭','17725374180','888@qq.com','http://localhost:9090/files/download/1748421487843-13.jpeg','认证通过');
...
CREATE TABLE `team` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='团队管理表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `team_application` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='组队申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `topic` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='选题信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `topic_evaluation`
--
...
CREATE TABLE `topic_evaluation` (
  ...
  `evaluation_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评价时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='选题评价表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `topic_evaluation`
--

LOCK TABLES `topic_evaluation` WRITE;
/*!40000 ALTER TABLE `topic_evaluation` DISABLE KEYS */;
INSERT INTO `topic_evaluation` VALUES (1,1,10,5.00,2.00,2.00,9.00,NULL,'已完成','2025-06-19 05:40:45');
/*!40000 ALTER TABLE `topic_evaluation` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user` (
  ...
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '头像',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (10,'aaa','123','USER','小明','13325803127','888@163.com','http://localhost:9090/files/download/1748308351607-4.jpg'),(11,'bbb','123','USER','王大壮','13325803127','123@qq.com','http://localhost:9090/files/download/1748422666574-6.jpeg'),(12,'ccc','123','USER','王甜甜','13725803127','888@163.com','http://localhost:9090/files/download/1748425504258-11.jpeg'),(13,'mmm','123','USER','mmm',NULL,NULL,NULL);
...
-- Dump completed on 2025-11-25 22:21:19
